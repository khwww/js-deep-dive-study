...
![](https://velog.velcdn.com/images/dlwnghd/post/9d786580-cb19-4f7b-92df-2d9e3dff8e5d/image.png)
...
- new target은 ES6에 도입된 최신 문법으로 IE에서는 지원하지 않는다. new.target을 사용할 수 없는 상황이라면 스코프 세이프 생성자 패턴을 사용할 수 있다.
